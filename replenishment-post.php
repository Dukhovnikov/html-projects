          ...
          <div class="col-md-4">
            <div class="replenishment-footnote-block">
              <div class="replenishment-footnote-block__data">
                <img class="replenishment-footnote-block__image" src="assets/img/replenishment-post/calendar.svg">
                <p class="replenishment-footnote-block__text">12.02.2020</p>
              </div>
              <div class="replenishment-footnote-block__data">
                <img class="replenishment-footnote-block__image" src="assets/img/replenishment-post/eye.svg">
